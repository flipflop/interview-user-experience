...
- Scenario: You arrive on a legacy Web Project, that utilises a Car Model locator. The designer choose to make all the available options available in a drop down.
	- Explain what problems this may present
	- Explain alternative UI Controls which may solve this problem better
	
	Anwser: the drop down will have far too many options to be easy to navigate for users (drop downs should only handle around 5 - 8 items).
		The solution can be improved greatly by using a Typeahead component to dynamically match searches for Car Models

- How do you work effectively and communicate with designers, developers, product owners and testers?

Answer: (very broad summary and stereotyping to follow)
...
- Who is Edward R Tufte?
	...
	Bonus: if 'Chart Junk' is mentioned
...
- Explain: 
	...
	Answer: Lean UX describes methods and their practical application in dynamic environment of a Lean Startup. Lean UX unites product development and business, through constant measurement and so called “learning loops” (build – measure – learn).
...
- How did Flat UI fail?

Answer: it attempted to remove many Skeumorphic elements and decoration in order to fully embrace Digtial Design. Unfortunately many of the elements removed improved the affordance of interactive elements, which includes buttons and links which became indestinguishable from other page content.  For example, many designers are attempting to add borders or drop shadows to buttons in order to raise their prominance and affordance.
...
- What are some of the main Accessibility considerations that affect User Experience Design decisions?
	Answer: 
		- Not all users use a mouse (some may require keyboard control or other Assistive Technologies - like a mouthpiece)
		- Some users are colour blind
		- Some users have Cognitive Impairment
